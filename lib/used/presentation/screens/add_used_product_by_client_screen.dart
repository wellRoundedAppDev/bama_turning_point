        ...
        body: BlocConsumer<AuthCubit, AuthStates>(
          ...
          builder: (context, state) {
            ...
            return (isUserLoggedIn == false)
                ? SignInScreen()
                : BlocConsumer<AddUsedProductByClientCubit,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomInput(
                                  hintText:
                                      AppLocalizations.of(context)!.enter_model,
                                ...
                                CustomInput(
                                  ...
                                  onSaved: (v) => addProductCubit
                                      .addProductInput.address = v?.trim(),
                                  validator: (v) {
                                    if (v == null || v.isEmpty) {
                                      return AppLocalizations.of(context)!
                                          .enter_address;
                                ...
                                CustomButton(
                                    isLoading: state
                                        is AddUsedProductByClientLoadingState,
