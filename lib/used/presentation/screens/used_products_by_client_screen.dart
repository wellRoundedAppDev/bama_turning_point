...
class UsedProductsByClientScreen extends StatelessWidget {
  const UsedProductsByClientScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocProvider(
          create: (context) => UsedProductsCubit(byClients: true)..init(),
                    ...
                    : (state is UsedProductsNetworkConnectionFailedState)
                        ? Padding(
                            ...
                            child: NoNetworkRefreshPage(
                              refresh: () async {
                                await cubit.setProductsByClient();
                              },
                            ),
                          )
                        : RefreshIndicator(
