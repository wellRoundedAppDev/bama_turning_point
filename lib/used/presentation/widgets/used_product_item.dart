...
class UsedProductItem extends StatelessWidget {
  ...
  UsedProductItem({Key? key, required this.usedProductItem}) : super(key: key);
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          "${AppLocalizations.of(context)!.motorcycle_name} ${usedProductItem?.name ?? ''}",
                          maxLines: 1,
                        ...
                        Text(
                          AppLocalizations.of(context)!.model +
                              " " +
                              (usedProductItem?.model?.toString() ?? ""),
                          //"\$${searchItem?.price}",
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
