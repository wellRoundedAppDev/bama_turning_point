                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          var product = cubit.result?[index];
                          int? productId = product?.id?.toInt();
                          String? productName = product?.productName;
                          String? productImageUrl =
                              ApiUrls.BASE_URL +
                                  (product?.files == null || product?.files?.isEmpty == true?"":     (product?.files?.first?.fileUrl??""));
                         var  priceFormatted =
                              product?.minorUnitPrice;
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                          ...
                                          builder: (context, state) {
                                            ...
                                            return Positioned(
                                                ...
                                                child: GestureDetector(
                                                  onTap: (){
                                                    WishListCubit.get(context).addItemToWishlist(productId??0, product?.source??0);
                                                  },
                                                  child: Container(
                                                      decoration: BoxDecoration(
                                  ...
                                  // ),
                                  Text(
                                    "${priceFormatted?.toString() ?? ""} ${AppLocalizations.of(context)!.iraqi_dinar_initials}",
