                        ...
                        children: [
                          ...
                          const Expanded(
                            ...
                            children: [
                              Text("عنوان الاشعار",
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(fontSize: FontSizes.FONT_SIZE_14,color: Colors.black,fontWeight: FontWeight.bold),
                              ),
                              SizedBox(
                                height: 4,
                              ),
                              Text(
                                  "هذا نص تجريبى لتوضيح تفاصيل الاشعار سوف يتم تعديله فى اقربوقت ممكن",
                                style: TextStyle(fontSize: FontSizes.FONT_SIZE_12,
                                color: AppColors.GREY_SUB_TITLE_COLOR,
                                  fontWeight: FontWeight.bold
                                ),
                          ...
                          const Text("Now",style: TextStyle(color: Color(0xff666666),
