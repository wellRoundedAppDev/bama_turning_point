    ...
    return SafeArea(
      ...
      body: BlocConsumer<AccountCubit, AccountStates>(
        ...
        builder: (context, state) {
          ...
          return (state is GetOrderDetailsLoadingState)?const Center(child: CircularProgressIndicator(),):
          ...
          RefreshIndicator(
            onRefresh: () async{
              await accountCubit.setOrderDetails(selectedOrderId??0);
            },
                           ...
                           Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    removeHTMLTags(selectedOrder?.paymentAddress1??"-"),
                                    textAlign: TextAlign.right,
                                    maxLines: 2,
                                    overflow: TextOverflow.ellipsis,
                                    style: const TextStyle(
