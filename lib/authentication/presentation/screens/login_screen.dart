          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CustomInput(
                  label: AppLocalizations.of(context)!.enter_your_main_userName,
                  hintText: AppLocalizations.of(context)!.enter_your_main_userName,
                  validator: (value) {
                    if (
                     value == null ||
                     value.isEmpty
                      ...
                      return AppLocalizations.of(context)!.enter_your_main_userName;
                    }
                  },
